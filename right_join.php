    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                $sql = "select f.email as foundUser, l.email as lostUser from found f right outer join lost l on f.item_id = l.item_id;";
                ...
                while($row = mysqli_fetch_array($result))
                {
                    ...
                    echo "<p>foundUser: " .$row['foundUser']. "</p>";
                    echo "<p>lostUser: " .$row['lostUser']. "</p>";
                    echo "</div>";
                    echo "</div>";
                }
